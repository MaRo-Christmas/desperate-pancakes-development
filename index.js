import{i as h,h as S}from"./assets/scroll-btn-D9WJ9Zll.js";import{a as m,i as n}from"./assets/vendor-CQpva9gi.js";document.addEventListener("DOMContentLoaded",()=>{const t=window.location.pathname;document.querySelectorAll(".menu-item .menu-link").forEach(e=>{e.closest(".menu-item").classList.toggle("active",t.endsWith(e.getAttribute("href").substring(1)))})});m.defaults.baseURL="https://your-energy.b.goit.study/api/";async function f(t,e,s){try{const r={filter:t,page:e,limit:s};return(await m.get("filters",{params:r})).data}catch{n.error({title:"Error",message:"Something went wrong! Please try again later!",position:"topRight",timeout:4e3})}}async function w(t){try{return(await m.get("exercises",{params:t})).data}catch{n.error({title:"Error",message:"Something went wrong! Please try again later!",position:"topRight",timeout:4e3})}}const y=document.getElementById("pagination");function v({_id:t,name:e,bodyPart:s,target:r,burnedCalories:a,time:c,rating:B}){return`
