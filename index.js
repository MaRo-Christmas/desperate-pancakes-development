import{i as h,h as $}from"./assets/scroll-btn-CI5fIfuT.js";import{a as p,i as n}from"./assets/vendor-CQpva9gi.js";document.addEventListener("DOMContentLoaded",()=>{const t=window.location.pathname;document.querySelectorAll(".menu-item .menu-link").forEach(e=>{e.closest(".menu-item").classList.toggle("active",t.endsWith(e.getAttribute("href").substring(1)))})});p.defaults.baseURL="https://your-energy.b.goit.study/api/";async function f(t,e,s){try{const r={filter:t,page:e,limit:s};return(await p.get("filters",{params:r})).data}catch{n.error({title:"Error",message:"Something went wrong! Please try again later!",position:"topRight",timeout:4e3})}}async function w(t){try{return(await p.get("exercises",{params:t})).data}catch{n.error({title:"Error",message:"Something went wrong! Please try again later!",position:"topRight",timeout:4e3})}}const y=document.getElementById("pagination");function v({_id:t,name:e,bodyPart:s,target:r,burnedCalories:a,time:c,rating:S}){return`
